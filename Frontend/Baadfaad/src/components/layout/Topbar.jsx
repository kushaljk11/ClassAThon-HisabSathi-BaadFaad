        ...
        <header className="w-full bg-white px-4 py-4 sm:px-6 lg:px-10">
            <div className="mx-auto flex w-full max-w-6xl items-center justify-between rounded-full border border-emerald-100 bg-zinc-100 px-4 py-3 sm:px-6">
                ...
                <nav className="hidden items-center gap-10 md:flex">
                    <a href={featuresHref} className="text-sm font-semibold text-black hover:text-slate-900">
                        Features
                    </a>
                    <a href={howItWorksHref} className="text-sm font-semibold text-black hover:text-slate-900">
                        How It Works
                    </a>
                    <Link to="/about" className="text-sm font-semibold text-black hover:text-slate-900">
                        About
                    </Link>
                    <Link to="/contact" className="text-sm font-semibold text-black hover:text-slate-900">
                        Contact
                    </Link>
                </nav>
